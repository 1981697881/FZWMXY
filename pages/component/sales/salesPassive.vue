						...
						<view class="flex">
							<view class="flex-sub">
								<view class="cu-form-group">
									...
									<input name="input" style="border-bottom: 1px solid;" :disabled="!popupForm.FIsStockMgr" v-model="popupForm.positions" />
	...
	methods: {
		...
		saveData() {
			...
			for (let i in list) {
				...
				console.log(list[i].childrenList)
				console.log(list[i])
